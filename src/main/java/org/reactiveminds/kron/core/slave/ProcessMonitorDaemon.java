...
import org.reactiveminds.kron.scheduler.vo.MilliSchedule;
import org.reactiveminds.kron.scheduler.vo.Schedule;
import org.reactiveminds.kron.utils.ProcessAlertListener;
import org.reactiveminds.kron.utils.ProcessMonitor;
...
class ProcessMonitorDaemon implements ScheduledDaemon, Closeable, ProcessAlertListener {
	...
	@Override
	public void onAlert(ProcessAlert type) {
